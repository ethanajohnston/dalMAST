...
#define CONTROL_SAIL_PRIORITY			  tskIDLE_PRIORITY + 3
...
#define CONTROL_SAIL_STACK_SIZE			configMINIMAL_STACK_SIZE	
...
extern enum TaskList running_task;

extern TaskHandle_t TaskHandles[TotalTasks];
